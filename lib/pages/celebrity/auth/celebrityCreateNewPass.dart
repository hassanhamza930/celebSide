...
class celebrityCreateNewPass extends StatefulWidget {
  @override
  _celebrityCreateNewPassState createState() => _celebrityCreateNewPassState();
}

class _celebrityCreateNewPassState extends State<celebrityCreateNewPass> {
  @override
